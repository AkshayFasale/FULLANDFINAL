...
Remember when you were a kid and thought the ideal dinner would just be all your favorite things mixed in a bowl? How did that Nutella Mac & Cheese taste? Well
...
food =  input("What type of food you like..! > ")
plant =  input("What plant you will use ? > ")
cooking = input("cooking method you use? > ")
burned_food = input("A word to describe your burned food > ")
item = input("A DIY item > ")

print (" ")
print("MENU")
print(cooking, food, "With", burned_food, plant, "On a bed of", item)