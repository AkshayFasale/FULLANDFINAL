...
print("Hello",name, "aYour ability to",superpower, "will make sure you never have to look at", enemy, "again. Go eat", favoritefood, "as you walk down the streets of", live, "and use", superpower,"for good and not evil!" )